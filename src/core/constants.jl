...
const emf_scenarios = ["IMAGE", "MERGE", "MESSAGE", "MiniCAM", "Scen5"]
...
# FAIR sampling
const _n_fair_samples = 2237
const _all_pulse_years = collect(2015:5:2105)
...
const HFC_list = [:HFC23, :HFC32, :HFC43_10, :HFC125, :HFC134a, :HFC143a, :HFC227ea, :HFC245fa, :HFC152a, :HFC236fa, :HFC365mfc]
